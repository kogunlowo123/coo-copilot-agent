"""COO Copilot Agent - Domain-Specific Connectors."""
...
class SnowflakeConnector:
    """Domain-specific connector for snowflake integration with COO Copilot Agent."""
...
class TableauConnector:
    """Domain-specific connector for tableau integration with COO Copilot Agent."""
...
class SalesforceConnector:
    """Domain-specific connector for salesforce integration with COO Copilot Agent."""
...
class WorkdayConnector:
    """Domain-specific connector for workday integration with COO Copilot Agent."""
...
class JiraConnector:
    """Domain-specific connector for jira integration with COO Copilot Agent."""
