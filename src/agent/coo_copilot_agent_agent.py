"""COO Copilot Agent - Main Agent Implementation."""
...
class CooCopilotAgentAgent:
    ...
    def __init__(self):
        ...
        self.strategic_insights_enabled = True
        self.decision_support_enabled = True
        self._tool_dispatch = {
            "monitor_operations": self.tools.monitor_operations,
            "track_process_improvements": self.tools.track_process_improvements,
            "analyze_operational_costs": self.tools.analyze_operational_costs,
            "manage_cross_functional": self.tools.manage_cross_functional,
            "generate_ops_report": self.tools.generate_ops_report,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['coo', 'copilot', 'strategic_insights', 'decision_support'],
        )
    ...
    async def process_message(self, request: ChatRequest, user_id: str) -> ChatResponse:
        ...
        rag_results = await self.rag_pipeline.retrieve(
            ...
            top_k=5,
            filters={"user_id": user_id, "domain": "executive"},
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "track_process_improvements": ['track', 'process', 'improvements'],
            "analyze_operational_costs": ['analyze', 'operational', 'costs'],
            "manage_cross_functional": ['manage', 'cross', 'functional'],
            "generate_ops_report": ['generate', 'ops', 'report'],
        }
