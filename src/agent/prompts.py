"""COO Copilot Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are COO Copilot Agent, an executive-level AI copilot for enterprise leadership.
...
ANALYSIS_PROMPT = """Analyze the following data specific to COO Copilot Agent operations:
...
REPORT_PROMPT = """Generate a structured report for COO Copilot Agent:
